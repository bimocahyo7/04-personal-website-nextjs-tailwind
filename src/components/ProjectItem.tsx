  ...
  return (
    <li className="h-full">
      <a href={url} target="_blank" rel="noopener noreferrer" className="h-full block">
        <div className="w-68 h-full flex flex-col rounded-xl overflow-hidden shadow-lg bg-white transform transition duration-300 hover:shadow-xl hover:scale-105 hover:shadow-orange-600/40">
          ...
          <div className="flex flex-col flex-grow px-6 py-4">
            ...
            <p className="text-sm text-gray-500 max-h-40 py-4 overflow-hidden">{description}</p>
          </div>
